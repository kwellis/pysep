...
# primary dimensions
vid = 8  # feet, this the ID, 9.5
lss = 30  # feet, actually 45 (for MEG, for similiar rates, we were looking at 45 feet...)
leff = 0.8 * lss
# liq_frac = 0.8
hoil = 6.5  # hhll is at seven feet
...
# POPS Vessel is 10' ID and 40' long...so twice as big...
